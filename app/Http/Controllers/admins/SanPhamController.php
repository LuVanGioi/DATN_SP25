...
class SanPhamController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        $danhMuc = DB::table("danh_muc_san_pham")->find($sanPham->ID_DanhMuc);
        $chatLieu = DB::table("chat_lieu")->find($sanPham->ID_ChatLieu);
        $thuongHieu = DB::table("thuong_hieu")->find($sanPham->ID_ThuongHieu);
        $danhSachHinhAnh = DB::table("hinh_anh_san_pham")->where("ID_SanPham", $id)->get();
    ...
    public function edit(string $id)
    {
        ...
        $danhSachChatLieu = DB::table("chat_lieu")->where("Xoa", 0)->orderByDesc("id")->get();
        $danhSachThuongHieu = DB::table("thuong_hieu")->where("Xoa", 0)->orderByDesc("id")->get();
        $danhSachBienThe = DB::table("bien_the_san_pham")->where("Xoa", 0)->where("ID_SanPham", $id)->orderByDesc("id")->get();
        $thongTinMauSac = DB::table("mau_sac")->where("Xoa", 0)->get();
        $thongTinKichCo = DB::table("kich_co")->where("Xoa", 0)->get();

        $danhSachHinhAnh = DB::table("hinh_anh_san_pham")->where("ID_SanPham", $id)->get();

        return view("admins.SanPham.SuaSanPham", compact( "sanPham", "danhSachDanhMuc", "danhSachChatLieu", "danhSachThuongHieu", "danhSachBienThe", "danhSachBienThe", "thongTinMauSac", "thongTinKichCo", "danhSachHinhAnh"));
    }
