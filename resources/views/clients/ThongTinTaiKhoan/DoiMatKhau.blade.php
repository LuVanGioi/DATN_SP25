...
@section("title")
    <title>Đổi mật khẩu - WD-14</title>
@endsection
                            ...
                            <form class="form-delivery" action="#">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group"><input required type="password" placeholder="Mật Khẩu"
                                                class="form-control"></div>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group"><input required type="password"
                                                placeholder="Xác Nhận Mật Khẩu" class="form-control"></div>
                                    </div>
