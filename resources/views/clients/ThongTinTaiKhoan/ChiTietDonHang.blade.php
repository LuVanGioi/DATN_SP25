        ...
        <div class="row mt-1">
            <div class="col-lg-9 col-md-9 col-sm-8">
                ...
                <div class="details-wrap">
                    <div class="block-title alt"><a href="{{ route("lich-su-don-hang.index") }}"><i class="fa fa-angle-left"></i></a> Đơn Hàng
                        <strong class="pull-right">Mã Đơn Hàng: #{{$chiTietDonHang->MaDonHang}} | <?= trangThaiDonHang($chiTietDonHang->TrangThaiDonHang); ?></strong>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="deltail-order">
                                ...
                                <span style="width: 100%">Địa Chỉ Nhận : {{$chiTietDonHang->DiaChi . ", " . $chiTietDonHang->Xa . " - " . $chiTietDonHang->TenHuyen . " - " . $chiTietDonHang->TenThanhPho}}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-body">
                            <div class="media" style="display: flex; align-items: center; gap: 15px; width: 100%; padding: 10px 5px">
                                ...
                                <div class="media-body ms-3"
                                    ...
                                    <div class="price d-flex" style="font-size: 14px; margin-bottom: 5px; color: black;">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="deltail-total-order">
                            <div><span>Giảm Giá:</span> <span>₫{{ number_format($chiTietDonHang->GiamGia) }}</span></div>
                            <div><span>Thành Tiền : </span> <span style="color: #010660">₫{{ number_format($chiTietDonHang->TongTien) }}</span></div>
                            <div><span>Phương Thức Thanh Toán :</span> <span style="font-weight: 500; font-size: 15px">{{$chiTietDonHang->PhuongThucThanhToan}}</span></div>
                        </div>
                    </div>
                </div>
