                ...
                <div class="col-sm-6">
                    ...
                    <form action="#" class="create-account">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h3 class="block-title">Login Today and You'll be able to</h3>
                                <ul class="list-check">
                            ...
                            <div class="col-md-6">
                                <a class="btn btn-block btn-theme btn-theme-dark btn-create" href="/dang-ky">Create
                                    Account</a>
                            </div>
                        </div>
                    </form>
