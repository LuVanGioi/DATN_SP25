    ...
    <section class="page-section breadcrumbs">
        <div class="container">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Trang Lưới Danh Mục Với Thanh Bên Trái</li>
            </ul>
        </div>
    </section>
                ...
                <aside class="col-md-3 sidebar" id="sidebar">
                    ...
                    <div class="widget widget-filter-price">
                        ...
                        <div class="widget-content">
                            ...
                            <button class="btn btn-theme">Lọc</button>
                        </div>
                    </div>
                    <div class="widget widget-tabs">
                        <div class="widget-content">
                            <ul id="tabs" class="nav nav-justified">
                                <li><a href="#tab-s1" data-toggle="tab">Hàng Đầu</a></li>
                                <li class="active"><a href="#tab-s2" data-toggle="tab">Giảm Giá</a></li>
                                <li><a href="#tab-s3" data-toggle="tab">Ưu Đãi</a></li>
                            </ul>
                                    ...
                                    <div class="product-list">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading"><a href="#">Tiêu Đề Sản Phẩm Chuẩn</a></h4>
                                                <div class="rating">
                                                    <span>
                            ...
                            <a class="btn btn-theme btn-theme-dark btn-theme-sm btn-block" href="#">Thêm Sản Phẩm</a>
                        </div>
                    </div>
                </aside>
                    ...
                    <div class="main-slider sub">
                        <div class="owl-carousel" id="main-slider">
                            <div class="item slide1 sub">
                                <img class="slide-img" src="clients/images/banner-1.jpg" alt="" />
                                <div class="caption">
                                    <div class="container">
                                        <div class="div-table">
                                            <div class="div-cell">
                                                <div class="caption-content">
                                                    <h2 class="caption-title"><span>Thời Trang Mùa Đông</span></h2>
                                                    <h3 class="caption-subtitle"><span>Bộ Sưu Tập Sẵn Sàng</span></h3>
                            ...
                            <div class="item slide2 sub">
                                <img class="slide-img" src="clients/images/banner-2.jpg" alt="" />
                                <div class="caption">
                                    <div class="container">
                                        <div class="div-table">
                                            <div class="div-cell">
                    ...
                    <div class="shop-sorting">
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-right-sm">
                                <a class="btn btn-theme btn-theme-transparent btn-theme-sm" href="#">
                                    <img src="clients/images/icon-list.png" alt="" />
                                </a>
                                <a class="btn btn-theme btn-theme-transparent btn-theme-sm" href="#">
                                    <img src="clients/images/icon-grid.png" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="thumbnail no-border no-padding">
                                <div class="media">
                                    <a class="media-link" href="#">
                                        <img src="clients/images/quan-ao-the-thao-nu.jpg" alt="" />
                                ...
                                <div class="caption text-center">
                                    <h4 class="caption-title" style="text-align: center;">Tiêu Đề Sản Phẩm Chuẩn</h4>
                                    <div class="rating">
                                        <span>
                                            <i class="fa-regular fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                    ...
                                    <div class="price"><ins>$400.00</ins> <del>$425.00</del></div>
                                    <div class="buttons">
                                        <a class="btn btn-theme btn-theme-transparent btn-wish-list" href="#">
                                            <i class="fa fa-heart"></i>
                                        </a>

                                        <a class="btn btn-theme btn-theme-transparent btn-icon-left" href="#">
                                            <i class="fa fa-shopping-cart"></i>
                                            Add to Cart
                                        </a>
                                        <a class="btn btn-theme btn-theme-transparent btn-compare" href="#">
