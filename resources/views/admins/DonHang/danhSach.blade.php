                        ...
                        <table class="table table-striped table-bordered nowrap dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->TrangThai == "danhan" || $item->TrangThai == "dagiao")
                                        <span class="text-success">Đã Thanh Toán</span>
                                        @else
                                        @if ($item->TrangThaiThanhToan == 'chuathanhtoan')
                                        <span class="text-warning">Chưa Thanh Toán</span>
                                        @elseif($item->TrangThaiThanhToan == "dathanhtoan")
                                        <span class="text-success">Đã Thanh Toán</span>
                                        @elseif($item->TrangThaiThanhToan == "huythanhtoan")
                                        <span class="text-primary">Hủy Thanh Toán</span>
                                        @else
                                        <span class="text-info">Khác</span>
                                        @endif
                                        @endif
                                    </td>
