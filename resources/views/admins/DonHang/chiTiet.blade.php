        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body">
                <div class="mb-4 p-3 border rounded">
                    ...
                    <p><strong>Trạng Thái Đơn Hàng : </strong> {!!trangThaiDonHang($donHang->TrangThaiDonHang)!!} </p>
                    <p><strong>Trạng Thái Thanh Toán : </strong> {!! ($donHang->PhuongThucThanhToan == "chuathanhtoan" ? "<span class='badge bg-danger'>Chưa Thanh Toán</span>" : "<span class='badge bg-success'>Đã Thanh Toán</span>") !!} </p>
                    <p><strong>Phương Thức Thanh Toán : </strong> {{$donHang->PhuongThucThanhToan}} </p>
                    <p><strong>Ghi Chú : </strong> {{$donHang->GhiChu}} </p>
                </div>
                <hr>
