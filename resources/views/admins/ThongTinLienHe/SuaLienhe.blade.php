                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error("DuongDan") is-invalid border-danger @enderror" type="url" name="DuongDan" placeholder="Liên Kết Đường Dẫn" value="{{ $thongTin->DuongDan }}" required>
                                        @error("DuongDan")
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
